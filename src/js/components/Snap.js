    ...
    return (
      <div className="gv-bbv-snap">
        ...
        <div className="gv-tranches">
          <div className="gv-snap-noes gv-tranche"><div className="gv-label gv-against">Against</div><div className="gv-count">{division.noesCount - division.noTellersCount}</div></div>
          <div className="gv-snap-ayes gv-tranche"><div className="gv-label gv-for">For</div><div className="gv-count">{division.ayesCount - ayeTellersCount}</div></div>
        </div>
